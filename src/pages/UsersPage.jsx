...
const API_URL = 'https://6900d2e1ff8d792314bba4cf.mockapi.io/api/users';
    ...
    <div>
        ...
        <div className='card mb-4'>
            <div className='card-body'>
                <h5 className='card-title'>{editingId ? 'Редактирование пользователя' :
                            ...
                            <div className='d-flex align-items-start mb-3'>
                                ...
                                <div className='flex-grow-1'>
                                    ...
                                    <p className='card-text mb-0'>
                                        <b>Любимая порода лошади: {user.horse}</b>
                                    </p>
                                </div>
                            </div>
